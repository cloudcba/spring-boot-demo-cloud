...
public class SystemLogAspect {
    ...
    @Pointcut("@annotation(com.neo.annotation.SystemControllerLog)")
    ...
    private void saveExceptionLog(ProceedingJoinPoint point, String exeMsg) {
        ...
        // 获取方法上LogFilter注解
        SystemControllerLog logFilter = method.getAnnotation(SystemControllerLog.class);
        String value = logFilter.description();
